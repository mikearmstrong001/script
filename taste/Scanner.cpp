...
void Scanner::Init() {
	...
	keywords.set(L"int", 4);
	keywords.set(L"bool", 5);
	keywords.set(L"float", 6);
	keywords.set(L"object", 7);
	keywords.set(L"userptr", 8);
	keywords.set(L"void", 9);
	keywords.set(L"var", 14);
	keywords.set(L"new", 18);
	keywords.set(L"true", 27);
	keywords.set(L"false", 28);
	keywords.set(L"function", 29);
	keywords.set(L"if", 33);
	keywords.set(L"else", 34);
	keywords.set(L"return", 35);
	keywords.set(L"while", 36);
	keywords.set(L"def", 37);
	keywords.set(L"extends", 38);
	keywords.set(L"package", 39);
